...
def generate_monster(world: dict, where: str) -> str:
    ...
    world["location"] = where
    if monster_number == 1:
        return render_template("monster1.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
                               where=where)
    elif monster_number == 2:
        return render_template("monster2.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster3.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster4.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster5.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster6.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster7.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster8.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
        ...
        return render_template("monster9.html", item1=world["inventory_one"],
                               item2=world["inventory_two"], item3=world["inventory_three"],
                               item4=world["inventory_four"], weapon=world["weapon"],
                               current_hp=world["character_current_hp"], total_hp=world["character_total_hp"],
                               experience=world["character_exp"], level=world["character_lvl"], name=current_monster,
